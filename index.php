...
// }
//热门推荐
$sqlos = "select  p.title, p.feature,p.content, p.views, p.likes from posts p order by p.views desc
limit 4;";
$topArr = query($connect, $sqlos);
// $topArr = [];
// while ($row = mysqli_fetch_assoc($tujResult)) {
//   $topArr[] = $row;
// }
// // print_r($postArr);
      ...
      $.ajax({
        ...
        success: function(res) {
          ...
          <div class="main">\
            ...
            var Maxtob = Math.ceil(res.pageCount / 5);
            console.log(Maxtob);
            console.log(currentPage);


            if (currentPage == Maxtob) {
              $(".loadmore .btn").hide();
            }
          }
        }
